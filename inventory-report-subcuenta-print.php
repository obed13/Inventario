...
ob_start();
	...
	if($action == 'ajax'){
		...
		$sWhere.=" and subcuenta.name LIKE '%".$query."%'";
		$sWhere.=" order by subcuenta.name ASC";
	...
	require_once (dirname(__FILE__).'/pdf/documentos/html/inventory-report-subcuenta.php');
