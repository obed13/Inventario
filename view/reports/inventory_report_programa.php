  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
	...
	function reporte(){
		...
		var manufacturer_id=$("#manufacturer_id").val();
		 ...
		 VentanaCentrada('inventory-report-print.php?action=ajax&product_code='+product_code+'&query='+query+'&manufacturer_id='+manufacturer_id,'Reporte inventario','','1024','768','true');
	}
	</script>
