...
<script>
	...
	function load(page){
		...
		var parametros = {"action":"ajax","page":page,'range':range,'purchase_by':purchase_by};
		$("#loader").fadeIn('slow');
		$.ajax({
...
<script>
	function reporte(){
		...
		var purchase_by=$("#purchase_by").val();
		 ...
		 VentanaCentrada('purchases-report-print.php?daterange='+daterange+"&purchase_by="+purchase_by,'Reporte compras','','1024','768','true');
	}
</script>
