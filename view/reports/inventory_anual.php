...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
	...
	function load(page){
		...
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'./ajax/reporte_inventario_anual_ajax.php',
			data: parametros,
	...
	function reporte(){
		...
		var fecha_fin=$("#fecha_fin").val();
		 ...
		 VentanaCentrada('inventory-report-anual-print.php?action=ajax&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin,'Reporte inventario','','1024','768','true');
	}
	...
	function reporte_excel(){
		...
		//VentanaCentrada('excel/excel_report_anual.php?action=excel&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin,'Reporte inventario','','1024','768','true');
		//VentanaCentrada('excel/reporte_excel.php?action=excel&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin,'Reporte inventario','','1024','768','true');
		location.href ='excel/excel.php?action=excel&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin;
		//VentanaCentrada('excel/excel.php?action=excel&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin,'Reporte inventario','','1024','768','true');
	}
	</script>