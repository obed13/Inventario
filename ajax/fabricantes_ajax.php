<?php
	...
	if ($count==0){
		...
		{
			$aviso="Aviso!";
			$msj="Error al eliminar los datos. El Empleado se encuentra vinculado con un producto";
			$classM="alert alert-error";
			$times="&times;";
		}	
				...
				<div class="table-responsive">
					<table class="table table-condensed table-hover table-striped">
						...
						while($row = mysqli_fetch_array($query)){	
							...
							$count=mysqli_query($con,"select count(*) AS num_prod from products where manufacturer_id='".$id."'" );
