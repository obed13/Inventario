...
if($action == 'ajax'){
	...
	$campos="products.product_id, products.product_code, products.product_name, products.note, products.status, products.buying_price, manufacturers.name as empleado, categoria.name, ubicacion.name as ubicacion";
	...
	$sWhere.=" order by manufacturers.name ASC";
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box">
				...
				<h3 class="box-title">Reporte de Empleados</h3>
				</div><!-- /.box-header -->
				<div class="box-body">
				<div class="table-responsive">
					<table class="table table-condensed table-hover table-striped ">
						...
						<tr>
                            ...
                            <td><a href="resguardo_empleado_print.php?code=<?php echo $product_code; ?>" target="_blank" class="btn btn-primary">Resguardar</a></td>
						</tr>
						<?php }?>
					</table>
				</div>
