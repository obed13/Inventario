<?php
	...
	$query_validate=mysqli_query($con,"select subcuenta_id from products where subcuenta_id='".$id."'");
	$count=mysqli_num_rows($query_validate);
	if ($count==0){
			if($delete=mysqli_query($con, "DELETE FROM subcuenta WHERE id='$id'")){
				$aviso="Bien hecho!";
		...
		{
			$aviso="Aviso!";
			$msj="Error al eliminar los datos. La subcuenta se encuentra vinculado con un producto";
			$classM="alert alert-error";
			$times="&times;";
		}	
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box">
				...
				<h3 class="box-title">Listado de Subcuenta</h3>
				</div><!-- /.box-header -->
				<div class="box-body">
				<div class="table-responsive">
					<table class="table table-condensed table-hover table-striped">
						...
						while($row = mysqli_fetch_array($query)){	
							...
							$count=mysqli_query($con,"select count(*) AS num_prod from products where subcuenta_id='".$id."'" );
