    ...
    require_once("../../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['product_id'])){
            ...
            $image_path=$_SESSION['img_tmp'];
				...
				// update data
                    $sql = "UPDATE evidencia SET model='".$model."',product_name='".$product_name."', presentation='".$presentation."', categoria_id='".$categoria_id."', ubicaciones_id='".$ubicacion_id."',
					note='".$note."',status='".$status."', manufacturer_id='".$manufacturer_id."', buying_price='".$buying_price."', selling_price='".$buying_price."', profit='".$profit."', image_path='".$image_path."' WHERE evidencia_id='$product_id' ";
