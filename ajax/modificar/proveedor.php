    ...
    require_once("../../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['supplier_id'])){
			...
			// escaping, additionally removing everything that could be (html/javascript-) code
				...
				$supplier_id=intval($_POST['supplier_id']);//ID del cliente
				
					// write new  data into database
                    $sql = "UPDATE suppliers, contacts_supplier SET suppliers.name='$name', suppliers.tax_number='$tax_number', suppliers.website='$website', suppliers.work_phone='$work_phone', contacts_supplier.first_name='$first_name', contacts_supplier.last_name='$last_name', contacts_supplier.email='$email', phone='$phone', address1='$address1', city='$city', state='$state', postal_code='$postal_code', country_id='$country_id'  WHERE suppliers.id=contacts_supplier.supplier_id and suppliers.id='".$supplier_id."'";
