    ...
    require_once("../../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['product_id'])){
			...
			// escaping, additionally removing everything that could be (html/javascript-) code
				...
				// INSERT DATA
                    $sql = "INSERT INTO evidencia (model, product_name, note, status, manufacturer_id,ubicaciones_id,categoria_id, buying_price,selling_price, profit, presentation, created_at, image_path) VALUES
												('$model', '$product_name', '$note', '$status', '$manufacturer_id','$ubicacion_id','$categoria_id', '$buying_price', '$buying_price', '$profit', '$presentation', '$created_at', '$image_path'); ";
