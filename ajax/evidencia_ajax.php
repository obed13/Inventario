<?php
	...
	if ($count==0){
		if($delete=mysqli_query($con, "DELETE FROM evidencia WHERE evidencia_id='$id'") ){
				$aviso="Bien hecho!";
...
if($action == 'ajax'){
	...
	$tables="evidencia, manufacturers";
	$campos="evidencia.evidencia_id, evidencia.model, evidencia.product_name, evidencia.status, evidencia.note, evidencia.image_path, evidencia.selling_price, manufacturers.name as empleado";
	$sWhere="evidencia.manufacturer_id=manufacturers.id";
	$sWhere.=" and evidencia.status=1";
	$sWhere.=" and manufacturers.name LIKE '%".$query."%'";
	$sWhere.=" order by evidencia.evidencia_id desc";
						...
						<tr>
							...
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="edit_evidencia.php?id=<?php echo $evidencia_id;?>"><i class='fa fa-edit'></i> Editar</a></li>
									<li><a href="detalle_evidencia.php?id=<?php echo $evidencia_id;?>"><i class='fa fa-folder'></i> Detalle</a></li>
									<?php }
									if ($permisos_eliminar==1){
									?>
									<li><a href="#" onclick="eliminar('<?php echo $evidencia_id;?>')"><i class='fa fa-trash'></i> Borrar</a></li>
									<?php }?>
								</ul>
							</div><!-- /btn-group -->
                    		</td>
