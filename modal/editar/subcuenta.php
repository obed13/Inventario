<?php
	...
	$id=$_GET["id"];
	$id=intval($id);
	$sql="select * from subcuenta where id='$id'";
...
<div class="form-group">
	...
	<div class="col-sm-6">
		<input type="text" class="form-control" id="name" name="name" placeholder="Ingresa la subcuenta" value="<?php echo $name;?>" required>
