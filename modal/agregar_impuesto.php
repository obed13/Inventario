    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="name" name="name" placeholder="Descripción del impuesto" required maxlength="100">
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-3">
				  <input type="text" class="form-control" id="value" name="value" placeholder="13" required maxlength="5">
				</div>
			  </div>
