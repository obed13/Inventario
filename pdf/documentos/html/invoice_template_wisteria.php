...
.border-bottom{
	border-bottom: #8e44ad 3px;
	padding-bottom:10px
}
.orange-top{
	border-top: #8e44ad 3px;
}
.orange-left{
	border-left: #8e44ad 3px;
}
.white{
...
<page backtop="10mm" backbottom="mm" backleft="0mm" backright="0mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:20px;">
		<tr>
			...
			<td style="width:60%;font-size:30px;color:#8e44ad;text-align:right;vertical-align:middle"><b>FACTURA </b></td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:14px;margin-top:20px;">
		<tr>
			<td style="width:5%;"> </td>
			<td style="width:45%;font-size:24px;color:#8e44ad;background-color:#ecf0f1;padding:20px"><b>FACTURAR A </b></td>
			<td style="width:45%;text-align:right;font-size:18px">
				<span style="color:#8e44ad">Factura Nº:</span> <?php echo $sale_number;?><br>
				<span style="color:#8e44ad">Fecha:</span> <?php echo $sale_date;?>
			</td>
...
?>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;margin-top:20px">
		...
		<tr>
			...
			<td style="width:25%;font-size:24px;" ></td>
			<td style="width:15%;font-size:14px;text-align:right;padding:5px;background-color:#8e44ad;color:white" ><b>TOTAL <?php echo $moneda;?>  </b></td>
			<td style="width:15%;font-size:14px;text-align:right;padding:5px;background-color:#8e44ad;color:white" ><?php echo number_format($total_compra,$currency_format['precision_currency'],$currency_format['decimal_separator'],$currency_format['thousand_separator']);?></td>
			<td style="width:5%;font-size:24px;text-align:center;"></td>
		</tr>
