...
.orange-bottom{
	border-bottom: #f39c12 3px;
}
.orange-top{
	border-top: #f39c12 3px;
}
.orange-left{
	border-left: #f39c12 3px;
}
.white{
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm" style="font-size: 12pt; font-family: arial" >
    <page_header>
        <table class="page_header" cellspacing=0 cellpadding=0 >
            <tr>
                ...
                <td style="width: 39%; text-align: left;background-color:#f39c12;" class='white' rowspan='2'>
                    <img style="width: 100%;" src="<?php echo $logo_url;?>" alt="Logo"><br>
                </td>
				<td style="width: 1%; text-align: left;background-color:white;" class='white'>
                    
                </td>
                <td style="width: 20%; text-align: center;vertical-align:middle;border-left:#f39c12 3px;" >
			...
			<tr>
                ...
                <td style="width: 20%; text-align: center;vertical-align:middle;border-left:#f39c12 3px;" class='orange-bottom'>
                    <?php echo $phone;?><br>
                </td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:14px;margin-top:120px">
		<tr>
			<td style="width:5%;"> </td>
			<td style="width:70%;font-size:24px;color:#f39c12"><b>FACTURAR A </b></td>
			<td style="width:20%;text-align:right">
				<span style="color:#f39c12">Factura Nº:</span> <?php echo $sale_number;?>
			</td>
			<td style="width:5%;"> </td>
		</tr>
		...
		<tr>
			...
			<td style="width:20%;text-align:right;">
				<span style="color:#f39c12">Fecha:</span> <?php echo $sale_date;?>
			</td>
			<td style="width:5%;"> </td>
		</tr>
	</table>
