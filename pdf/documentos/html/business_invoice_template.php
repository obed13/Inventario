...
<page backtop="10mm" backbottom="mm" backleft="0mm" backright="0mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:20px;">
		<tr>
			...
			<td style="width:60%;font-size:30px;color:#3498db;background-color:white;text-align:right;vertical-align:middle"><b>FACTURA </b></td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:14px;margin-top:20px">
		<tr>
			<td style="width:5%;"> </td>
			<td style="width:45%;font-size:24px;color:#3498db;background-color:#ecf0f1;padding:20px"><b>FACTURAR A </b></td>
			<td style="width:45%;text-align:right">
				<span style="color:#3498db">Factura Nº:</span> <?php echo $sale_number;?><br>
...
?>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;margin-top:20px">
		...
		<tr>
			...
			<td style="width:15%;font-size:14px;text-align:right;padding:5px;background-color:#3498db;color:white" ><?php echo number_format($total_compra,$currency_format['precision_currency'],$currency_format['decimal_separator'],$currency_format['thousand_separator']);?></td>
			<td style="width:5%;font-size:24px;text-align:center;"></td>
		</tr>
